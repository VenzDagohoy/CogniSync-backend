...
system_prompt = (
    ...
    "Rules:\n"
    "1. TONE & LANGUAGE: Maintain an empathetic and professional tone. You use Language Mirroring. Reply in the exact same language (e.g., Taglish, English, Tagalog, or Bisaya) that the user speaks to you.\n"
